...
const Home = () => {
  ...
  const fetchBestSellers = async () => {
    try {
      setLoading(true);
      const response = await fetch(
        "https://sportgoods-api.onrender.com/api/Products/best-sellers?numOfBestSellers=3"
      );
      if (!response.ok) {
    ...
    <div className="min-h-screen">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">Добре дошли в SportGoods</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-body">
                Бърза и надеждна доставка до вашия адрес
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-body">
                Всички продукти са качествено проверени
              </p>
            </div>
            ...
            <div className="card p-6 text-center">
              ...
              <p className="text-body">
                30-дневна политика за връщане на всички продукти
              </p>
            </div>
          </div>
        </div>
